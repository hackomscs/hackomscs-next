  ...
  return (
    <Holder>
      <a href={sponsor.link} target="_blank" rel="noreferrer">
        <Image alt='sponsor image' src={sponsor.img} layout="fill" objectFit='contain'/>
      </a>
    </Holder>
  )
}
...
export default function SponsorGrid() {
  ...
  return (
    <Container dark={dark}>
      ...
      <ShadowHolder><Image alt='shadow holder' src={shadow} layout="fill" objectFit='contain'/></ShadowHolder>
      <ShadowHolder right><Image alt='shadow holder right' src={shadow} layout="fill" objectFit='contain' /></ShadowHolder>
    </Container>
  )
}